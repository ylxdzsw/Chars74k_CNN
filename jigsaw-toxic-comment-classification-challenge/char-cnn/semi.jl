...
@main function train(epoch::Int=100)
    ...
    for i in 1:epoch
        ...
        i % 20 == 0 && model.save("D:/jigsaw-toxic-comment-classification-challenge/result/semi-char-cnn.model")
    end
end
...
@main function predict()
    ...
    model = pywrap(pyimport("model")[:Model](length(V)+2, "gpu", "D:/jigsaw-toxic-comment-classification-challenge/result/semi-char-cnn.model"))

    open("D:/jigsaw-toxic-comment-classification-challenge/result/semi-char-cnn.submission.csv", "w") do fout
...
@main function feature()
    ...
    open("D:/jigsaw-toxic-comment-classification-challenge/result/semi-char-cnn.feature.csv", "w") do fout
