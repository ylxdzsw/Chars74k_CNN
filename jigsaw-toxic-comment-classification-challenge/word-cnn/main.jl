...
@main function train(epoch::Int=100)
    ...
    for i in 1:epoch
        ...
        i % 20 == 0 && model.save("D:/jigsaw-toxic-comment-classification-challenge/result/word-cnn.model")
    end
end
...
@main function predict()
    ...
    model = pywrap(pyimport("model")[:Model](M, "gpu", "D:/jigsaw-toxic-comment-classification-challenge/result/word-cnn.model"))

    open("D:/jigsaw-toxic-comment-classification-challenge/result/word-cnn.submission.csv", "w") do fout
...
@main function feature()
    ...
    open("D:/jigsaw-toxic-comment-classification-challenge/result/word-cnn.feature.csv", "w") do fout
